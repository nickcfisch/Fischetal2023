...
setwd(paste0("/blue/edvcamp/nfisch/Chapter_4/",substr(model,9,14),"_noSS"))
#Compile and load model 
if(surv==TRUE){
   TMB_name<-paste0(substr(model,9,14),"_noSS_wsurv")
} else if (surv==FALSE){
   TMB_name<-paste0(substr(model,9,14),"_nosurv")
  }
  
  if(wEff==TRUE){
   TMB_name<-paste0(substr(model,9,14),"_wEff")
  }
...
#OM11
#run_TMB(N=1:100,model="OM11SM11EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM12EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM13EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM21EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM22EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM23EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM31EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM32EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM33EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM21
#run_TMB(N=1:100,model="OM21SM11EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM12EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM13EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM21EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM22EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM23EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM31EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM32EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM33EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM31
#run_TMB(N=1:100,model="OM31SM11EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM12EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM13EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM21EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM22EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM23EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM31EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM32EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM33EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM41
#run_TMB(N=1:100,model="OM41SM11EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM12EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM13EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM21EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM22EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM23EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
run_TMB(N=1:100,model="OM41SM31EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
run_TMB(N=1:100,model="OM41SM32EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
run_TMB(N=1:100,model="OM41SM33EM1112_noSS_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
