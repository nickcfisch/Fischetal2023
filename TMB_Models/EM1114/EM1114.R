...
#The models where we have to do a switcheroo to get an effort time series
  ...
  lower_bounds<-c(-5,-20,-20,rep(-10,dat$lyear+dat$lage), 0, 10, -5,-5,-5,-5,-2, 0,-5,-7,-10,-10,-10,-10,-10,-10,rep(-20,dat$lyear))
  upper_bounds<-c( 2,  1,  1,rep( 10,dat$lyear+dat$lage), 1, 25,  2, 2, 2, 2, 5,20, 5, 5, 20, 20, 20, 20, 20, 20,rep( 0,dat$lyear))
  
  if(wEff==TRUE){
   par<-par[-which(names(par)=="log_fint")]
   lower_bounds<-c(-5,-20,-20,rep(-10,dat$lyear+dat$lage), 0, 10, -5,-5,-5,-5,-2,  0,-5,-7,-10,-10,-10,-10,-10,-10)
   upper_bounds<-c( 2,  1,  1,rep( 10,dat$lyear+dat$lage), 1, 25,  2, 2, 2, 2, 5, 20, 5, 5, 20, 20, 20, 20, 20, 20)
  }
  ...
  tryCatch({
   ...
   while(counter==1 & is.null(SCAA_fit$hessian) & convcounter < 5){
    ...
    par <- list(log_M_scalar=log(0.099),log_q=jitter(-12.65,jfactor),log_q_FIM=jitter(-14.275, jfactor),
                ...
                FIM_sellogis_k=jitter(2,jfactor),FIM_sellogis_midpt=jitter(2,jfactor),lsig_LN=jitter(-1,jfactor),lsig_LN_surv=jitter(-1,jfactor),
    ...
    par <- list(log_M_scalar=log(0.099),log_q=jitter(-12.65,jfactor),log_q_FIM=jitter(-14.275, jfactor),
                ...
                FIM_sellogis_k=jitter(2,jfactor), FIM_sellogis_midpt=jitter(2,jfactor),lsig_LN=jitter(-1,jfactor),
                lsig_LN_surv=jitter(-1,jfactor),B1=jitter(3.17,jfactor),B2=jitter(-4.18,jfactor),
...
#OM11
#run_TMB(N=1:100,model="OM11SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM11SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM12
#run_TMB(N=1:100,model="OM12SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM12SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM21
#run_TMB(N=1:100,model="OM21SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM21SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM22
#run_TMB(N=1:100,model="OM22SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM22SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM31
#run_TMB(N=1:100,model="OM31SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM31SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM32
#run_TMB(N=1:100,model="OM32SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM32SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM41
#run_TMB(N=1:100,model="OM41SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM41SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
run_TMB(N=1:100,model="OM41SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
run_TMB(N=1:100,model="OM41SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
run_TMB(N=1:100,model="OM41SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);

#OM42
#run_TMB(N=1:100,model="OM42SM11EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM12EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM13EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM21EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM22EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM23EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM31EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM32EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
#run_TMB(N=1:100,model="OM42SM33EM1114_wsurv", surv=TRUE, Est_Rsd=TRUE, PE="PE", wEff=FALSE);
